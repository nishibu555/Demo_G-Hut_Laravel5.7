			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="{{URL::to('/all_product')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Product</span></a>
					    </li>

						<li><a href="{{URL::to('/add_product')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Product</span></a>
						</li>

						<li><a href="{{URL::to('/sell_report')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Sell Report</span></a></li>

						<li><a href="{{URL::to('/manage_order')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Manage Order</span></a></li>
						...
						<li><a href="{{URL::to('/add_sub_category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Sub category</span></a></li>


						<li><a href="{{URL::to('/all_manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">
							All Brand
						</span></a></li>
						...
						<li><a href="{{URL::to('/add_slider')}}"><i class="icon-edit"></i><span class="hidden-tablet">Add Slider</span></a></li>
                         ...
                         <li><a href="{{URL::to('/top_manufacture')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Top manufacture</span></a></li>

                         <li><a href="{{URL::to('/all_top_manufacture')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">All Top Manufacture</span></a></li>



						<li><a href="{{URL::to(' ')}}"><i class="icon-font"></i><span class="hidden-tablet">Name of shop</span></a></li>
