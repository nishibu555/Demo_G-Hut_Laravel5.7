				...
				<div class="box span12">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('/save_sub_category')}}">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="sub_category_name" 
                            ...
                            <div class="control-group">
								...
								<div class="controls">
								  ...
								  <select id="selectError3" name="category_id">
								  	...
								  	<?php 
                                    $front_category=DB::table('tbl_category')->get();
							...
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">Add Sub Catageory</button>
